 ...
 */
 ...
 function calcularChurras(){
     let KGCarne, Cerveja, Refrigerante, Homens, Mulheres, Crianças, TotalCarne, TotalCerveja, TotalRefrigerante, DiviaoHeM
     Crianças = parseFloat(frmChurrasco.valorCrianças.value.replace(",","."))
